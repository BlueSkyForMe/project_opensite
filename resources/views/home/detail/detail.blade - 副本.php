							...
							<div class="details_options">
								...
								<div class="options_box">
										...
										<div class="box_two">
											...
											<div>
												<select name="guestType" id="">
													<option>类型</option>
													<option name="1">单人间</option>
													<option name="2">标准间(双床)</option>
													<option name="3">双人间</option>
													<option name="4">套间客房</option>
													<option name="5">公寓式客房</option>
													<option name="6">总统套房</option>
													<option name="7">特色客房</option>
												</select>
											</div>
...
<script type="text/javascript">
	...
	// =======================点击茶歇,客房,设备============================
  	...
  	// 书写 ajax, 调用后台数据
      $.get('/home/detail/ajax', {"value": inputCode}, function(data){

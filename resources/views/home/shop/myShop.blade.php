		...
		<div class="main">
			...
			<!--\\\\\\\\\\\\\\\\\在这之间写你的HTNL代码\\\\\\\\\\\\\\\\\\\\\\\\\-->
					...
					<!-- 订单具体内容 -->
						<div class="order_content">
							...
							<ul>
								...
								<li class="con_fiest">
									<div>
										...
										<div class="con_name ">
											<p style="margin-left:30px;margin-top:25px;">会议茶歇</p>
											<!-- <div class="con_des"><span>地方方正</span><span>装修精美</span></div> -->
										</div>
									</div>
								</li>
							...
							<ul>
								...
								<li class="con_fiest">
									<div>
										<!-- <div class="con_img"><img src="{{ asset('/restimg/order_2.png') }}"></div> -->
										<div class="con_name ">
											<p style="margin-left:30px;margin-top:25px;">会议客房</p>
											<!-- <div class="con_des"><span>地方方正</span><span>装修精美</span></div> -->
										</div>
									</div>
								</li>
							...
							<ul>
								...
								<li class="con_fiest">
									<div>
										<!-- <div class="con_img"><img src="{{ asset('/images/order_2.png') }}"></div> -->
										<div class="con_name ">
											<p style="margin-left:30px;margin-top:25px;">AV设备</p>
											<!-- <div class="con_des"><span>地方方正</span><span>装修精美</span></div> -->
										</div>
									</div>
								</li>
				...
				<div class="count">
					...
					<div class="sm_a" ><button class="qibie" style="float:right;border:none"><input type="image" src="{{ asset('/images/pay.png') }}"></button></div>
				</div>
	...
	<script type="text/javascript">
		...
		$('.qibie').each(function(){
			...
			$(this).click(function(){
				...
				// alert(value);
				$.get('/home/shop/ajax', {"meet": value}, function(data){

			// alert(data);
			if(data)
			{
				alert('请前往支付');location.href='/home/index';
			}else
			{
				alert('数据异常');
			}
